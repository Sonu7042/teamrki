    ...
    ================================ */
        ...
        if ($('.testimonial-slider').length > 0) {
            const testimonialSlider = new Swiper(".testimonial-slider", {
                ...
                loop: true,
                autoplay: {
                    delay: 3000, // autoplay interval (3s)
                    disableOnInteraction: false, // autoplay continue even after user interaction
                },
                navigation: {
                    nextEl: ".array-next", // fix (next and prev reversed earlier)
                    prevEl: ".array-prev",
                },
                pagination: {
                    el: ".dot",
